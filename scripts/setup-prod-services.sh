...
echo "   Convex: npx convex env set RESEND_API_KEY re_... --prod (docs/features/RESEND.md)"
echo "   Or Next.js (no Convex): Vercel RESEND_* + NEXT_PUBLIC_LEAD_API=true → POST /api/lead"
